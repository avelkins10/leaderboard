...
export function Nav() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-border bg-card">
      <div className="mx-auto flex h-14 max-w-[1440px] items-center gap-1 px-6 lg:px-10">
        <Link href="/" className="mr-8 flex items-center gap-2.5 transition-opacity hover:opacity-70">
