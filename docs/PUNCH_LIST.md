...
### C2: Name matching uses .includes() — can false-match
...
### C4: Frontend field name mismatch after data.ts refactor
...
### C5: Rep API redefines isCancel locally (shadowing import)
